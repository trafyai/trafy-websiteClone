...
//         try {
//             // Firebase URL to store all course form data in a single document
//             let firebaseURL = "https://uiux-beginners-formdata-default-rtdb.firebaseio.com/course-enquiries.json";
    
//             // Determine which course type is being submitted
//             const courseType = courseType || "beginners"; // Assuming 'beginners' is default
//             const dataToSave = {
//                 ...formData,
//                 courseType: courseType, // Add course type to the data
...
//             if (!response.ok) {
//                 throw new Error(`Failed to save data to Firebase: ${response.statusText}`);
//             }
    
//             const responseData = await response.json();
//             console.log("Firebase Response Data:", responseData);
    
//             // Razorpay order creation and payment handling code remains the same
//             const paymentType = paymentType === "MasterClass" ? "MasterClass" : "MasterClass";
           
//             const amount = parseInt(props.courseFee); // Amount based on the type
