...
//     const [subAccordionId, setSubAccordionId] = useState(props.contents.subContent[0]?.id || null);
...
//     const selectedAccordionContent = props.contents.find(item => item.id === selectedId);
...
//                 <div className="accordion-container" style={{ width: "40%", border: "1px solid", display: "flex", flexDirection: "column" }}>
...
//                                 <div key={subIndex} onClick={() => handleSubAccordionClick(item.id)}>
//                                     <p>{subItem.title}</p>
//                                 </div>
//                            ))}
...
//     const [accordionId, setAccordionId] = useState(props.contents[0]?.id || null);
//     const [subAccordionId, setSubAccordionId] = useState(props.contents.subContent[0]?.id || null);
//     const [accOpen,setAccOpen] = useState(flase)
...
//                            <p>{item.title}</p>
//                            {accOpen &&
//                            {item.subContent && item.subContent.map((subItem, subIndex) => (
//                                 <div 
//                                     className="sub-accordion-box"
//                                     key={subIndex} 
//                                     style={{ padding: "8px", cursor: "pointer", border: "1px solid #ddd" }}
//                                     onClick={() => handleSubAccordionClick(subItem.id)}
//                                 >
//                                     <p>{subItem.title}</p>
//                                 </div>
//                            ))}
